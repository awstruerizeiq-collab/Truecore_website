...
//     RefreshCw, UserCheck, ChevronRight, Calendar,
//     Phone, Badge, AlertCircle, Loader2
// } from "lucide-react";
...
//     const [teamLeadInfo, setTeamLeadInfo] = useState({ employeeId: "", name: "" });
...
//         setTeamLeadInfo({ employeeId, name, tenantCode });
//     }, []);

//     /* ── Fetch team members once we have the employeeId ── */
//     const fetchMembers = async () => {
//         const { employeeId, tenantCode } = teamLeadInfo;
...
//                 `${API_BASE_URL.replace(/\/+$/, "")}/api/employee-details/team-lead/${encodeURIComponent(tenantCode)}/${encodeURIComponent(employeeId)}`,
//                 {
//                     headers: {
...
//     useEffect(() => {
//         if (teamLeadInfo.employeeId) fetchMembers();
//     }, [teamLeadInfo.employeeId]);
...
//                         <button onClick={() => { setSearch(""); setStatusFilter("ALL"); }} className="text-xs text-blue-600 underline">
//                             Clear filters
//                         </button>
//                     </div>
//                 )}
