...
import com.hireconnect.service.AccountDetailsService;
...
public class AccountDetailsController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> create(@Valid @RequestBody AccountDetailsDto dto) {
        Map<String, Object> res = new HashMap<>();
        try {
            res.put("success", true);
            res.put("message", "Account details created successfully");
    ...
    public ResponseEntity<Map<String, Object>> update(
        ...
        try {
            res.put("success", true);
            res.put("message", "Account details updated successfully");
    ...
    public ResponseEntity<Map<String, Object>> delete(
        ...
        try {
            ...
            res.put("success", true);
            res.put("message", "Account details deleted successfully");
            return ResponseEntity.ok(res);
        } catch (Exception e) {
            res.put("success", false);
            res.put("message", e.getMessage());
