...
import com.hireconnect.service.PersonalDetailsService;
...
public class PersonalDetailsController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> create(@Valid @RequestBody PersonalDetailsDto dto) {
        Map<String, Object> res = new HashMap<>();
        try {
            res.put("success", true);
            res.put("message", "Personal details created successfully");
    ...
    public ResponseEntity<Map<String, Object>> update(
        ...
        try {
            ...
            res.put("success", true);
            res.put("message", "Personal details updated successfully");
    ...
    public ResponseEntity<Map<String, Object>> delete(
        ...
        try {
            ...
            res.put("success", true);
            res.put("message", "Personal details deleted successfully");
            return ResponseEntity.ok(res);
        } catch (Exception e) {
            res.put("success", false);
            res.put("message", e.getMessage());
